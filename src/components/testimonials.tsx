  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-20">
        ...
        <motion.div className="mb-12 flex flex-col gap-4 lg:mb-16 lg:flex-row lg:items-end lg:justify-between" {...inView()}>
          ...
          <div className="flex items-center gap-2">
            <div className="flex gap-0.5">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="h-5 w-5 fill-[#facc15]" viewBox="0 0 20 20">
        ...
        {/* Featured quote */}
        <motion.div className="mb-10 border-l-[3px] border-[#facc15] pl-6 lg:pl-8" {...inView(0.1)}>
          <p className="font-sans mb-6 text-xl leading-relaxed text-white italic lg:text-2xl lg:leading-relaxed">
            "{featured.text}"
          </p>
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-[#facc15]">
          ...
          {reviews.map((review, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-2.5">
                <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-[#facc15]/20">
                  <span className="font-display text-[12px] font-bold text-[#facc15]">
                    {review.name[0]}
                  </span>
                </div>
