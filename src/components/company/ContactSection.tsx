      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-20">
        <div className="flex flex-col items-start justify-between gap-8 bg-[#0f0f0f] px-8 py-10 sm:flex-row sm:items-center lg:px-12 lg:py-12">
          ...
          <div className="flex flex-col gap-4">
            <a
              href="tel:5127483225"
              className="font-display inline-flex items-center justify-center bg-[#facc15] px-8 py-4 text-[15px] font-bold uppercase tracking-[0.06em] text-[#0f0f0f] transition-opacity hover:opacity-90"
            >
              (512) 748-3225
            </a>
            <a
